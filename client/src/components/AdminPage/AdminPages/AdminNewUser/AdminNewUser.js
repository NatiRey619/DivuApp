...
<div className='add-new-user'>
 ...
 name="user-name-val" id="user-name" type="text" />
...
<label for="first-name">Enter first name</label>
  <input onChange={(e) => {
          ...
          }} name="first-name-val" id="first-name" type="text"  />
  ...
  <input onChange={(e) => {
          ...
          }} name="last-name-val" id="last-name" type="text"/>
          

  <label for="worker-email">Enter Email</label>
  <input onChange={(e) => {
            setUserEmail(e.target.value);
          }} name="worker-email-val" id="worker-email" type="text"/>
  ...
  <input onChange={(e) => {
          ...
          }} name="worker-password-val" id="worker-password"  type="text"/>
    <div>
